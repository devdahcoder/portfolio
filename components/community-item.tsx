...
const CommunityItem = (props: Props) => {
    ...
    return (
        <div 
            key={currentItem?.id}
            className="
                group relative rounded-sm w-full min-w-[25rem] medium-sm:min-w-[26rem] large-xs:min-w-[28rem] h-full flex flex-col items-start 
            ...
            >
                ...
                <div className="flex flex-col">
                    <div className="flex flex-col space-y-9 medium-sm:space-y-10 large-xs:space-y-11">
