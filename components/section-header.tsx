...
// text-8xl
    return (
        <div className={`flex flex-col ${containerClassName}`}>
            <div className={`text-6xl small-large:text-7xl medium-sm:text-8xl text-dark-bg dark:text-white font-medium leading-6 small-large:leading-8 medium-sm:leading-9 opacity-20 ${sectionClassName}`}>
                <h1>{sectionTitle}</h1>
            </div>
            {/* leading-9 */}
