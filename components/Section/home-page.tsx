...
const HomePage = (props: Props) => {
    return (
        <div className="
                flex flex-col large-sm:flex-row items-center medium-xs:items-start justify-center large-sm:justify-between relative w-full px-4
            ...
            >
                ...
                <div className="group text-4xl small-xs:text-5xl medium-xs:text-6xl large-sm:text-7xl extra-large-xs:text-8xl
                ...
                <div className="
                    ...
                    medium-xs:pr-3 extra-large-xs:pr-24"
                >
                    <p>
            ...
            <div className="w-full large-sm:max-w-[23rem] flex flex-col items-center h-[35rem]">
                ...
                >
                    ...
                    <div
                        className="z-0 
                            w-[10rem] small-xs:w-[13rem] small-mid:w-[14rem] medium-xs:w-[19rem] large-sm:w-[18.5rem]
                            h-fit absolute left-1/2 large-sm:left-2 -translate-x-1/2 large-sm:translate-x-0
                            top-16 large-sm:top-6
